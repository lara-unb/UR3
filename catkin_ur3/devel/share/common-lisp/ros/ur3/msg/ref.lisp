...
(cl:defmethod cl:initialize-instance :after ((m <ref>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ref)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur3-msg:<ref> is deprecated: use ur3-msg:ref instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ref>))
...
(cl:defmethod ref-val ((m <ref>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur3-msg:ref-val is deprecated.  Use ur3-msg:ref instead.")
  (ref m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ref>) ostream)
  "Serializes a message object of type '<ref>"
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'header) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'ref) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ref>) istream)
  "Deserializes a message object of type '<ref>"
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'ref) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ref>)))
  ...
  "d9c5cf74122eba439d6b5d26b6ae8e33")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ref)))
  "Returns md5sum for a message object of type 'ref"
  "d9c5cf74122eba439d6b5d26b6ae8e33")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ref>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'ref))
))
